            ...
            if(Math.abs(worst.ratioDiff) <= ranges.ideal) {
                ...
                //////////////////////////////////////////////////////////////////////
                    ...
                    if(worst.ratioDiff < 0) {
                        diagnosis = (
                            <span>
                                Since your overhead squat is lower than ideal relative to your snatch, and since this is the
                                biggest disparity in the numbers you entered, it tells us you likely have a problem with overhead
